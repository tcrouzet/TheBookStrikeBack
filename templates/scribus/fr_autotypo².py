#!/usr/bin/env python
# -*- coding: utf-8 -*-
# File: fr_autotypo².py Version : 1.2 - 2025 06 16
...
# + normalizes ⋅
#
# © 2020.06-2025.06 Creation of autotypo by JLuc 
# following © 2013 autoquote2 enhancements by JLuc 
# following © 2026 autoquote2 enhancements by JLuc 
# of © 2010 autoquote.py by Gregory Pittman 
# and including 2023.10 fixes by Vincent
#
# For issues or enhancements, use https://bugs.scribus.net/view.php?id=17562
# (previous tracker : https://bugs.scribus.net/view.php?id=16804)
#
...
# - - replaces ⋅ BULLET OPERATOR with ∙ DOT OPERATOR
...
# do_ask = True # ask each possible setting value
do_ask=False    # dont ask, run with default value = french + all auto typo normalization
...
replace_glyph_title="Remplacer les points médian"
bad_glyph="⋅"
ok_glyph="∙"
if (lang=='fr'):
	do_replace_glyph=True
else:
	do_replace_glyph=False
...
if do_ask:
  if bad_glyph:
    do_replace_glyph = scribus.valueDialog(replace_glyph_title,
                "Voulez vous corriger les points médians ? \n  O : Oui\n  N : Non ",
                'O')
